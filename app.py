...
def ver_video():
    ...
    auto_capture = request.args.get('autoCapture', '1')
...
def handle_connect():
    ...
    print(f'Cliente conectado: {request.sid} desde IP: {client_ip}')
...
if __name__ == '__main__':
    print("Servidor iniciado - Socket.IO disponible en http://0.0.0.0:5000", flush=True)
